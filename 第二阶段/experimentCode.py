    ...
    try:
        ...
        for num in range(4):
            ...
            if pose:
                ...
                # str_distance = str(front_data_position.x)
            ...
            _ = t265_distance_array[num] - robo_angle_array[num]
            str_angle = str(_)
            f2.write(str_angle)
            f2.write(' \t ')
            t265_z_angle_array[num] = late_data_position.x - front_data_position.x
            robo_z_angle_array[num] = new_z[num+1] - new_z[num]
            z_angle = t265_z_angle_array[num] - robo_z_angle_array[num]
            str_z_angle = str(z_angle)
