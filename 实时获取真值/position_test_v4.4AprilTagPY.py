...
def PnPProcess(Points3D, Points0, CamIn, CDistortCoe):
    ...
    #print(CamWR)
    print(str(CamW[0, 0]).ljust(20) + "\t" + str(CamW[1, 0]).ljust(20) + "\t" + str(CamW[2, 0]).ljust(20) + "\n" +
         str(RVec[0, 0]).ljust(20) + "\t" + str(RVec[1, 0]).ljust(20) + "\t" + str(RVec[2, 0]).ljust(20) + "\n",
         file=doc)
    #print(str(CamW[0, 0]).ljust(20) + "\t" + str(CamW[1, 0]).ljust(20) + "\t" + str(CamW[2, 0]).ljust(20) + "\n" +
    #      str(RVec[0, 0]).ljust(20) + "\t" + str(RVec[1, 0]).ljust(20) + "\t" + str(RVec[2, 0]).ljust(20) + "\n" +
    #      str(TVec[0, 0]).ljust(20) + "\t" + str(TVec[1, 0]).ljust(20) + "\t" + str(TVec[2, 0]).ljust(20) + "\n",
    #     file=doc)
    #print(str(CamW[0, 0]).ljust(20) + "\t" + str(CamW[1, 0]).ljust(20) + "\t" + str(CamW[2, 0]).ljust(20) + "\n" +
    #      str(RVec[0, 0]).ljust(20) + "\t" + str(RVec[1, 0]).ljust(20) + "\t" + str(RVec[2, 0]).ljust(20) + "\n" +
    #      str(TVec[0, 0]).ljust(20) + "\t" + str(TVec[1, 0]).ljust(20) + "\t" + str(TVec[2, 0]).ljust(20) + "\n")
...
Points3DAll = np.array([[[ 0, 0, 0],[74, 0, 0],[74, 74, 0],[0, 74, 0]]], dtype = "double")
...
#while(True):
    ...
    if len(tags)==0:
        ...
        if ID > MaxIndex:
            ...
            #print(Point2DNp)
            # Point3D = Points3DAll[int(ID), 0:4, 0:1]
